      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Ready to Transform Your Business with AI Development!
          </h2>
          <p className="text-gray-700 mb-8">
            Ready to transform your corporation with an AI Development? Contact Webblaze nowadays and allow us that will help you create the proper chatbot on your wishes.
          </p>
