      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Get Started with Webblaze AI News Anchor Service

          </h2>
          <p className="text-gray-700 mb-8">
           To learn extra approximately how Webblaze’s AI information anchor service can gain your enterprise, schedule a consultation with our experts.
          </p>
