...
const Section_b = () => {
  const features = [
    ...
    {
      title: 'Scalability',
      description: 'Our answers are scalable, permitting your platform to grow along with your commercial enterprise. Whether you\'re starting with a small user base or aiming for millions, our infrastructure supports your growth.',
  ...
  return (
    <div className="bg-gray-100 py-12 px-4 sm:px-6 lg:px-8 font-inter">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-800 text-center mb-10 leading-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`bg-white rounded-xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden border-b-4 ${feature.borderColor}`}
            >
              <div className="p-6 sm:p-8">
                <div className={`w-14 h-14 sm:w-16 sm:h-16 rounded-full flex items-center justify-center ${feature.iconBgColor} mb-4 sm:mb-6`}>
                  <span className={`${feature.iconTextColor}`}>
                    {feature.icon}
                  </span>
                </div>
