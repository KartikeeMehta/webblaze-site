      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start justify-between gap-10 mb-20">
          <div className="md:w-1/2">
            <h3 className="text-xl md:text-3xl font-bold text-[#F75C4E] mb-4">
              Initial Consultation
            </h3>
            <h4 className="text-lg md:text-2xl font-semibold text-[#1A1A1A] mb-3">
              Understanding Your Needs
            </h4>
            <div className="text-lg pl-4 border-l border-gray-300 space-y-2 text-[#333]">
