      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-700 mb-8">
            By choosing Webblaze on your Google Ads needs, you are partnering with a group dedicated for your fulfillment. Our complete services, expert facts, and commitment to excellence make us the best desire for corporations seeking to thrive on line.
          </p>
