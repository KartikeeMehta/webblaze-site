        ...
        >
            <div className="max-w-[1200px] mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-10 rounded-3xl p-8 ">
                <div className="flex-1">
                    <h2 className="text-2xl md:text-5xl font-bold leading-snug text-red-500 ">
                        Growth Marketing  {" "}
                ...
                <div className="flex-1">
                    <img
                        src={
                            "https://webblazesofttech.com/wp-content/uploads/2024/08/Growth-Marketing-Online-for-Business-1.webp"
                        }
                        alt="WordPress Developer"
                        className="rounded-3xl w-full max-h-[] object-cover"
                    />
                </div>
            </div>
        </div>
