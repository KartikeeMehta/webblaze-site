            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                       Ready to take your commercial enterprise to the subsequent level with PPC advertising and marketing?
                    </h2>
                    <p className="text-gray-700 mb-8">
                      Contact Webblaze today to get started out. Our team of specialists is here to help you gain your advertising dreams.
                    </p>
