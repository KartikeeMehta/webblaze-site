...
const Section_c = () => {
    return (
        <div className="relative bg-[#0F172A] bg-[url('background-lines.webp')] text-white py-20 px-6 sm:px-10">
            <div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-6xl mx-auto mt-16 relative z-10 text-center">
                <div>
                    ...
                    <p className="text-md leading-relaxed">
                        ...
                        choices for continuous development.
                ...
                <div>
                    ...
                    <p className="text-md leading-relaxed">
                        ...
                        each search engines like Google and readers.
            ...
            <div className="max-w-4xl mx-auto mt-16 text-center relative z-10">
                ...
                <p className="text-md leading-relaxed">
                    ...
                    improving usual consumer revel in and search engine ratings.We offer comprehensive search engine marketing audits to discover and
