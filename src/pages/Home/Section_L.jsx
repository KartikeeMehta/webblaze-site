...
const blogs = [
  ...
  {
    id: 1,
    title: "Shopify Store Tips",
    date: "May. 18/2023",
    image: "https://webblazesofttech.com/wp-content/uploads/2025/06/165-2.jpg",
    description:
      "Discover how carpool administration software transforms corporate commuting. Learn its benefits, key features, and business impact in this in-depth guide.",
  },
  {
    id: 3,
    title:
  ...
  },
  {
    id: 8,
    title:
      "Smarter Commutes: Why Carpool Software is Transforming Corporate Travel and Employee Mobility",
    date: "May. 18/2023",
    image: "https://webblazesofttech.com/wp-content/uploads/2025/06/165-2.jpg",
    description:
      "Discover how carpool administration software transforms corporate commuting. Learn its benefits, key features, and business impact in this in-depth guide.",
  ...
  return (
    <section className="bg-[#f7f9fc] py-16 px-4 overflow-x-hidden">
      <div className="text-center mb-12">
        <p className="text-red-500 text-[24px] font-semibold mb-2">Blog</p>
      ...
      <div ref={scrollRef} className="flex gap-10 max-w-6xl mx-auto p-2">
        {blogs.map((blog) => (
          ...
          >
            ...
            <p className="text-base text-gray-500 mb-4">{blog.description}</p>
