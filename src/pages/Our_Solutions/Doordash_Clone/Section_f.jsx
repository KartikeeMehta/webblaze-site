            ...
            <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
                        Ready to Launch Your Doordash clone?
                    </h2>
                    <p className="text-gray-700 mb-8">
                        Launching your personal Doordash clone app has by no means been simpler. At Webblaze, we provide end-to-quit improvement services, making sure your app is ready to compete with enterprise giants like Uber Eats, Zomato, and Swiggy.
