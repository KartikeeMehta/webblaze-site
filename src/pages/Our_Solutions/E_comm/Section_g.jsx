...
const faqs = [
  {
    ...
    answer: 'Choose a platform, add products, set up payment and shipping options, and promote your site online.'
  },
  {
    question: 'How much does it cost to build an ecommerce website?',
    answer: 'Costs vary from $5,000 to $50,000+, depending on features and design.'
  },
  {
    question: 'What are the must-have features for an ecommerce website?',
    answer: 'Essential features include user-friendly navigation, secure checkout, mobile responsiveness, and detailed product pages.'
  },
  {
    question: 'Which platform is best for ecommerce development?',
    answer: 'Popular platforms include Shopify, WooCommerce, Magento, and BigCommerce.'
  },
  {
    question: 'How do ecommerce websites attract customers?',
    answer: 'Strategies include SEO, social media marketing, email campaigns, and offering discounts or promotions.'
  }
];
