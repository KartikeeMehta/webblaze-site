      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Ready to take your on-line organisation to the following degree with our e-trade improvement offerings?
          </h2>
          <p className="text-gray-700 mb-8">
            Talk to our professional these days and get started on constructing your ecommerce internet website.
          </p>
