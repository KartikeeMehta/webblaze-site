      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Get Started with Webblaze’s Hospital Management Software
          </h2>
          <p className="text-gray-700 mb-8">
            To research more approximately how Webblaze’s health center control software program can transform your healthcare facility, time table a consultation with our experts. Visit our website or contact us on the information below:
          </p>
