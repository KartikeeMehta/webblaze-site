      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Ready to revolutionize your taxi company with a cutting-edge-day-day app?
          </h2>
          <p className="text-gray-700 mb-8">
            Webblaze is right right here to help you every step of the manner. Our expert institution is dedicated to turning in a incredible, function-rich taxi app that meets your organization dreams. Contact us these days to talk about your undertaking and note how we can supply your vision to life.
          </p>
