        ...
        >
            <div className="max-w-[1200px] mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-10 rounded-3xl p-8 ">
                ...
                <div className="flex-1">
                    ...
                    <p className="mt-6 text-gray-700 text-base md:text-sm leading-relaxed">At Webblaze, we specialise in leveraging the strength of React.Js to craft seamless and interactive net applications that captivate users and power enterprise growth. As a main net improvement organisation, we deliver unheard of know-how in harnessing React.Js to construct scalable answers tailored in your unique needs.
                    </p>
