                ...
                {blogs.map((blog) => (
                    ...
                    >
                        <div className="rounded-xl overflow-hidden mb-4">
                            <img src={blog.image} alt={blog.title} className="w-full h-50 object-contain" />
                        </div>
