...
const Section_b = () => {
  return (
    <section className="bg-[#fdfbfb] py-20 px-6 sm:px-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-1/2">
            ...
            <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
              User Interface (UI) and User Experience (UX) design are pivotal in shaping how users engage with digital merchandise. UI focuses on the visible elements, inclusive of format, shades, and typography, making sure that the interface is aesthetically stunning and intuitive. UX, alternatively, delves into the general revel in of the person journey, aiming to create seamless and meaningful interactions. At Webblaze, our UI UX layout services are meticulously crafted to enhance every component.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-10">
          <div className="md:w-1/2 flex justify-center">
            <img
              ...
              className="rounded-full w-64 h-64 object-cover border-4 border-red-400"
            />
          </div>
          <div className="md:w-1/2">
            <h3 className="text-2xl font-bold text-gray-900 mb-4">
