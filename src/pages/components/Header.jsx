      ...
      <div className="flex items-center justify-between max-w-[1200px] m-auto p-5">
        ...
        <nav className="hidden lg:flex gap-[15px] text-gray-800 text-sm font-medium cursor-pointer">
          <div
            ...
            <Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">Services</Link>
            {showDropdown && (
          ...
          <div
            ...
            <Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">Our Solutions</Link>
            {onSolutions && (
              <div className="absolute top-full left-0 w-[800px] bg-white shadow-xl rounded-xl p-6 grid grid-cols-3 gap-4 z-50">
          ...
          <div className="relative group"
            ...
            onMouseLeave={() => setOnMarketingItems(false)}><Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">Digital Marketing</Link>
            {onMarketingItems && (
          ...
          <div className="relative group"
            ...
            <Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">Blockchain</Link>
            {onBlockChain && (
              <div className="absolute top-full left-0 w-[250px] bg-white shadow-xl rounded-xl p-4 z-50">
                <div className="flex flex-col gap-3">
          ...
          <div className="relative group"
            ...
            <Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">AI</Link>
            {onAi && (
          ...
          <div className="relative group"
            ...
            <Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">Metaverse</Link>
            {onMetaverseItems && (
              <div className="absolute top-full left-0 w-[200px] bg-white shadow-xl rounded-xl p-4 z-50">
                <div className="flex flex-col gap-3">
          ...
          <div className="relative group"
            ...
            <Link to="/" className="hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition duration-200 pb-1">3D Animation</Link>
            {onAnimationItems && (
              <div className="absolute top-full left-0 w-[250px] bg-white shadow-xl rounded-xl p-4 z-50">
                <div className="flex flex-col gap-3">
          ...
          <NavLink
            to="/About_us"
            className={({ isActive }) =>
              `pb-1 border-b-2 transition duration-200 ${isActive ? 'text-blue-600 border-blue-600' : 'hover:text-blue-600 hover:border-blue-600 border-transparent'
              }`
            }
          >
            About Us
