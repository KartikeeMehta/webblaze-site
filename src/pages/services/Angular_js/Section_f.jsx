      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Ready to leverage the energy of Angular.Js to your next internet task?          </h2>
          <p className="text-gray-700 mb-8">
            Talk to our professional nowadays to speak about your mission and find out how Webblaze will let you reap your format dreams.      </p>
