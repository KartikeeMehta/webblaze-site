      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-700 mb-8">
            At Webblaze, we are passionate about JavaScript and its potential to revolutionize web development. Our team of experts is dedicated to delivering innovative solutions that exceed your expectations. Whether you need a custom web application, a comprehensive JavaScript course, or strategic consulting, Webblaze is your trusted partner in the digital world.
          </p>
