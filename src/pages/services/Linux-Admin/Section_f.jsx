      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-6 text-gray-900">
            Ready to take the following step for your Linux administration adventure?
          </h2>
          <p className="text-gray-700 mb-8">
            Don’t miss out at the opportunity to improve your profession with pinnacle-notch Linux management training and offerings. Explore our services and begin your journey toward turning into a certified Linux administrator with Webblaze.
          </p>
