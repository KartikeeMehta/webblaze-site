    ...
    <div className="min-h-screen bg-[#0d1117] text-white py-16 px-4">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-400 mb-12 max-w-2xl mx-auto">
          Our professional internet layout services cover the whole thing from
          preliminary concept to very last launch. We manage all additives of
          internet design, together with
        </p>
