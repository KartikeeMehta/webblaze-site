      ...
      <div className="max-w-[1200px] mx-auto px-4 flex flex-col md:flex-row gap-8 md:gap-16 justify-center items-center">
        ...
        <div className="flex-1 max-w-xl">
          ...
          <p className="text-gray-600 mb-6">
            By choosing Webblaze, you’re selecting a reliable and innovative photography solution that will help you stand out in the competitive industry. Let us bring your vision to life with our expert services.
          </p>
